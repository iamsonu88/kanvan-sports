                      ...
                      <div class="post_image">
                          ...
                          <div class="imgwrap">    
                              <div class="icon_wrap animated fadeInUp">
                                	<a class="imgzoom" href="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'full'); echo $image[0]; ?>" title="<?php echo _e('Preview','sktgravida'); ?>" data-title="<?php the_title(); ?>"><i class="fa fa-search"></i></a>

                              		<a href="<?php the_permalink();?>" title="<?php echo _e('Read More','sktgravida'); ?>"><i class="fa fa-plus"></i></a>
                              </div>                 
                          ...
                          <div class="imgwrap">       
                              <div class="icon_wrap animated fadeInUp">
                                	<a class="imgzoom" href="<?php echo complete_gallery_thumb('complete_thumb'); ?>" title="<?php echo _e('Preview','sktgravida'); ?>" data-title="<?php the_title(); ?>"><i class="fa fa-search"></i></a>
                              		<a href="<?php the_permalink();?>" title="<?php echo _e('Read More','sktgravida'); ?>"><i class="fa fa-plus"></i></a>
                              </div>            
                          ...
                          <div class="imgwrap">
							<div class="icon_wrap animated fadeInUp">
                              		<a href="<?php the_permalink();?>" title="<?php echo $complete['recentpost_block_button']; ?>"><i class="fa fa-plus"></i></a>
			...
			<div class="lay4_wrap_ajax">
                ...
                <!--POST THUMBNAIL START-->
                 ...
                 <!--POST THUMBNAIL END-->
                    ...
                    <!--POST CONTENT START-->
                        <div class="post_content">
                         ...
                         <!--META INFO START-->   
                            ...
                            <?php } else { ?><div class="meta_comm"><?php comments_popup_link( __('0 Comment', 'sktgravida'), __('1 Comment', 'sktgravida'), __('% Comments', 'sktgravida'), '', __('Off' , 'sktgravida')); ?></div><?php } ?>
                            	<!--CATEGORY-->
                    ...
                    <!--POST CONTENT END-->
					<!--Read More Button-->
                    <div class="blog_mo"><a href="<?php the_permalink();?>">+ <?php echo $complete['recentpost_block_button']; ?></a></div>
