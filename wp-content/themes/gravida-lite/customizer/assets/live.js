...
// --------------------------------
	...
	wp.customize( 'complete[featured_section_title]', function( value ) { value.bind( function( newval ) { $( '.featured_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[homeblock_color_id]', function( value ) { value.bind( function( newval ) { 
		$('.featured_area').css({"background-color":newval});
		} );   
	});	
	
	wp.customize( 'complete[homeblock_bg_setting]', function( value ) { value.bind( function( newval ) { 
		$('.featured_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[featured_image_height]', function( value ) { value.bind( function( newval ) { 
		$('.featured_block img').css({"height":newval});
		} );   
	});	
	
	wp.customize( 'complete[featured_image_width]', function( value ) { value.bind( function( newval ) { 
		$('.featured_block img').css({"width":newval});
		} );   
	});		
	
	wp.customize( 'complete[featured_block_bg]', function( value ) { value.bind( function( newval ) { 
		$('.featured_block').css({"background-color":newval});
		} );   
	});		
	
	wp.customize( 'complete[featured_block_button_bg]', function( value ) { value.bind( function( newval ) { 
		$('.sktmore').css({"background-color":newval});
		} );   
	});	
	
	wp.customize( 'complete[featured_block_hover_button_bg]', function( value ) { value.bind( function( newval ) { 
		$('.sktmore:hover').css({"background-color":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.featured_area' ).addClass('hide_section');}   if(newval == ''){ $( '.featured_area' ).removeClass('hide_section');}  } );
	} );	
	
 	// Home Section 1
	wp.customize( 'complete[section1_title]', function( value ) { value.bind( function( newval ) { $( '.home1_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section1_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home1_section_area').css({"background-color":newval});
		} );   
	});	
	
	wp.customize( 'complete[section1_content]', function( value ) { value.bind( function( newval ) { 
		$('.home_section1_content').html( newval );
		} );   
	});	
	wp.customize( 'complete[section1_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home1_section_area_bg').css({"background-image":newval});
		} );   
	});		
	
	wp.customize( 'complete[hide_boxes_section1]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home1_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home1_section_area' ).removeClass('hide_section');}  } );
	} );		
	// Home Section 1	
	
 	// Home Section 2
	wp.customize( 'complete[section2_title]', function( value ) { value.bind( function( newval ) { $( '.home2_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section2_content]', function( value ) { value.bind( function( newval ) { $( '.home_section2_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section2_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home2_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section2_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home2_section_area_bg').css({"background-image":newval});
		} );   
	});			
	
	wp.customize( 'complete[hide_boxes_section2]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home2_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home2_section_area' ).removeClass('hide_section');}  } );
	} );	
	// Home Section 2
	
 	// Home Section 3
	wp.customize( 'complete[section3_title]', function( value ) { value.bind( function( newval ) { $( '.home3_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section3_content]', function( value ) { value.bind( function( newval ) { $( '.home_section3_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section3_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home3_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section3_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home3_section_area_bg').css({"background-image":newval});
		} );   
	});			
	
	wp.customize( 'complete[hide_boxes_section3]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home3_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home3_section_area' ).removeClass('hide_section');}  } );
	} );	
	// Home Section 3
	
 	// Home Section 4
	wp.customize( 'complete[section4_title]', function( value ) { value.bind( function( newval ) { $( '.home4_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section4_content]', function( value ) { value.bind( function( newval ) { $( '.home_section4_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section4_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home4_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section4_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home4_section_area_bg').css({"background-image":newval});
		} );   
	});			
	
	wp.customize( 'complete[hide_boxes_section4]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home4_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home4_section_area' ).removeClass('hide_section');}  } );
	} );	
	// Home Section 4
	
 	// Home Section 5
	wp.customize( 'complete[section5_title]', function( value ) { value.bind( function( newval ) { $( '.home5_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section5_content]', function( value ) { value.bind( function( newval ) { $( '.home_section5_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section5_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home5_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section5_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home5_section_area_bg').css({"background-image":newval});
		} );   
	});			
	
	wp.customize( 'complete[hide_boxes_section5]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home5_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home5_section_area' ).removeClass('hide_section');}  } );
	} );	
	// Home Section 5
	
 	// Home Section 6
	wp.customize( 'complete[section6_title]', function( value ) { value.bind( function( newval ) { $( '.home6_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section6_content]', function( value ) { value.bind( function( newval ) { $( '.home_section6_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section6_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home6_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section6_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home6_section_area_bg').css({"background-image":newval});
		} );   
	});		
	
	wp.customize( 'complete[hide_boxes_section6]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home6_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home6_section_area' ).removeClass('hide_section');}  } );
	} );		
	// Home Section 6
	
 	// Home Section 7
	wp.customize( 'complete[section7_title]', function( value ) { value.bind( function( newval ) { $( '.home7_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section7_content]', function( value ) { value.bind( function( newval ) { $( '.home_section7_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section7_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home7_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section7_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home7_section_area_bg').css({"background-image":newval});
		} );   
	});		
	
	wp.customize( 'complete[hide_boxes_section7]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home7_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home7_section_area' ).removeClass('hide_section');}  } );
	} );		
	// Home Section 7
	
 	// Home Section 8
	wp.customize( 'complete[section8_title]', function( value ) { value.bind( function( newval ) { $( '.home8_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section8_content]', function( value ) { value.bind( function( newval ) { $( '.home_section8_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section8_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home8_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section8_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home8_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section8]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home8_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home8_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 8
	
 	// Home Section 9
	wp.customize( 'complete[section9_title]', function( value ) { value.bind( function( newval ) { $( '.home9_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section9_content]', function( value ) { value.bind( function( newval ) { $( '.home_section9_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section9_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home9_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section9_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home9_section_area_bg').css({"background-image":newval});
		} );   
	});			
	
	wp.customize( 'complete[hide_boxes_section9]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home9_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home9_section_area' ).removeClass('hide_section');}  } );
	} );	
	// Home Section 9
	
 	// Home Section 10
	wp.customize( 'complete[section10_title]', function( value ) { value.bind( function( newval ) { $( '.home10_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section10_content]', function( value ) { value.bind( function( newval ) { $( '.home_section10_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section10_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home10_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section10_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home10_section_area_bg').css({"background-image":newval});
		} );   
	});		
	
	wp.customize( 'complete[hide_boxes_section10]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home10_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home10_section_area' ).removeClass('hide_section');}  } );
	} );		
	// Home Section 10
	
 	// Home Section 11
	wp.customize( 'complete[section11_title]', function( value ) { value.bind( function( newval ) { $( '.home11_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section11_content]', function( value ) { value.bind( function( newval ) { $( '.home_section11_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section11_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home11_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section11_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home11_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section11]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home11_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home11_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 11	
	
 	// Home Section 12
	wp.customize( 'complete[section12_title]', function( value ) { value.bind( function( newval ) { $( '.home12_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section12_content]', function( value ) { value.bind( function( newval ) { $( '.home_section12_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section12_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home12_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section12_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home12_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section12]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home12_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home12_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 12
	
 	// Home Section 13
	wp.customize( 'complete[section13_title]', function( value ) { value.bind( function( newval ) { $( '.home13_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section13_content]', function( value ) { value.bind( function( newval ) { $( '.home_section13_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section13_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home13_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section13_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home13_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section13]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home13_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home13_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 13
	
 	// Home Section 14
	wp.customize( 'complete[section14_title]', function( value ) { value.bind( function( newval ) { $( '.home14_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section14_content]', function( value ) { value.bind( function( newval ) { $( '.home_section14_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section14_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home14_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section14_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home14_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section14]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home14_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home14_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 14
	
 	// Home Section 15
	wp.customize( 'complete[section15_title]', function( value ) { value.bind( function( newval ) { $( '.home15_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section15_content]', function( value ) { value.bind( function( newval ) { $( '.home_section15_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section15_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home15_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section15_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home15_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section15]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home15_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home15_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 15
	
 	// Home Section 16
	wp.customize( 'complete[section16_title]', function( value ) { value.bind( function( newval ) { $( '.home16_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section16_content]', function( value ) { value.bind( function( newval ) { $( '.home_section16_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section16_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home16_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section16_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home16_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section16]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home16_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home16_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 16
	
 	// Home Section 17
	wp.customize( 'complete[section17_title]', function( value ) { value.bind( function( newval ) { $( '.home17_section_area h2' ).html( newval );  } );  } );
	
	wp.customize( 'complete[section17_content]', function( value ) { value.bind( function( newval ) { $( '.home_section17_content' ).html( newval );  } );  } );	
	wp.customize( 'complete[section17_bgcolor_id]', function( value ) { value.bind( function( newval ) { 
		$('.home17_section_area').css({"background-color":newval});
		} );   
	});	
	wp.customize( 'complete[section17_bg_image]', function( value ) { value.bind( function( newval ) { 
		$('.home17_section_area_bg').css({"background-image":newval});
		} );   
	});	
	
	wp.customize( 'complete[hide_boxes_section17]', function( value ) {
		value.bind( function( newval ) {   if(newval ==1){ $( '.home17_section_area' ).addClass('hide_section');}   if(newval == ''){ $( '.home17_section_area' ).removeClass('hide_section');}  } );
	} );			
	// Home Section 17															
	...
	wp.customize( 'complete[mnbg_color_id]', function( value ) { value.bind( function( newval ) { 
		$('#topmenu .menu_hover > a, #topmenu .current-menu-item a, #topmenu .current_page_item a, #topmenu ul li ul:not(.mega-sub-menu)').css({"background-color":newval});
		} );   
	} );
	...
	wp.customize( 'complete[testimonialbox_color_id]', function( value ) { value.bind( function( newval ) { 
		$('.testimonial-box').css({"background-color":newval});
		$('.testimonial-box:after').css({"border-top-color":newval});
		} );   
	} );
	
	
	// Testimonial Pager
	wp.customize( 'complete[testimonial_pager_color_id]', function( value ) { value.bind( function( newval ) { 
		$('.bx-wrapper .bx-pager.bx-default-pager a').css({"background":newval});
		} );   
	} );	
	
	// Testimonial Active Pager
	wp.customize( 'complete[testimonial_activepager_color_id]', function( value ) { value.bind( function( newval ) { 
		$('.bx-wrapper .bx-pager.bx-default-pager a:hover, .bx-wrapper .bx-pager.bx-default-pager a.active').css({"background":newval});
		} );   
	} );
	...
	wp.customize( 'complete[features_text_color]', function( value ) { value.bind( function( newval ) {  
		$('.left-fit-title h3, .right-fit-title h3, .left-fit-desc, .right-fit-desc').css({"color":newval});  } );   
	} );
	
	wp.customize( 'complete[features_text_color]', function( value ) { value.bind( function( newval ) {  
		$('.left-fitright, .right-fitleft').css({"background-color":newval});  } );   
	} );
	
	wp.customize( 'complete[features_text_hover_color]', function( value ) { value.bind( function( newval ) {  
		$('.left-fitbox a:hover h3, .right-fitbox a:hover h3').css({"color":newval});  } );   
	} );	
	
	wp.customize( 'complete[features_text_hover_color]', function( value ) { value.bind( function( newval ) {  
		$('.left-fitbox a:hover .left-fitright, .right-fitbox a:hover .right-fitleft').css({"background-color":newval});  } );   
	} );
	
	wp.customize( 'complete[features_ordernumber_color]', function( value ) { value.bind( function( newval ) {  
		$('.right-fitleft, .right-fitleft').css({"color":newval});  } );   
	} );
	
	wp.customize( 'complete[features_bottom_border_color]', function( value ) { value.bind( function( newval ) {  
		$('.right-fit-desc, .left-fit-desc').css({"border-bottom-color":newval});  } );   
	} );
