...
?>
    <div class="lay1">
        <div class="center">
            ...
            <div class="lay1_wrap <?php if(!empty($complete['lay_show_title']) ) { ?>lay1_tt_on<?php }?>">
                      ...
                      <div class="post_image">
                          ...
                          <div class="imgwrap">    
                              <div class="icon_wrap animated fadeInUp">
                                	<a class="imgzoom" href="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full'); echo $image[0]; ?>" title="<?php echo _e('Preview','sktgravida'); ?>" data-title="<?php the_title(); ?>"><i class="fa fa-search"></i></a>
