<?php
/**
 * The MAIN FUNCTIONS FILE for gravida
 *
...
function Complete_setup() {
	...
	load_theme_textdomain('sktgravida', get_template_directory() . '/languages/');  
	...
	register_nav_menus( array(
			'primary' => __( 'Header Navigation', 'sktgravida' ),
		) );
	}
...
function skt_complete_import_files() {
  return array(
    array(
      'import_file_name'             => 'Import Gravida Lite Demo',
...
add_action( 'widgets_init', 'create_copyright' );
...
add_action( 'init', 'custom_theme_assets' );
