<?php 
/**
 * The Comment section for gravida
 *
...
<?php
	...
	<p class="nocomments"><?php _e('This post is password protected. Enter the password to view comments.', 'sktgravida'); ?></p>
	<?php
	return;
	}
?>
...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
    ...
    <!--COMMENT RESPONSE COUNT START-->
        <h3 id="comments">
            <?php comments_number(__( 'No Responses', 'sktgravida'), __('One Response', 'sktgravida'), __('% Responses', 'sktgravida'));?> to &#8220;<a><?php the_title(); ?></a>&#8221;
        </h3>
...
<?php if ( ! empty($comments_by_type['pings']) ) : ?>
	...
	<!--PINGS Title-->
    <h3 id="comments_ping"><?php _e('Trackbacks &amp; Pings', 'sktgravida'); ?></h3>
...
<?php if ( !is_page() ) { ?><p class="nocomments"><?php _e('Comments are closed.', 'sktgravida'); ?></p><?php } ?>
