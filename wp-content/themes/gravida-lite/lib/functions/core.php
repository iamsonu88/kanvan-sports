<?php
 /**
 * The CORE functions for gravida
 *
...
function complete_widgets_init(){
	...
	'name'          => __('Blog Sidebar', 'sktgravida'),
	'id'            => 'sidebar-blog',
	'description'   => __('When you assign widgets to this area, it will be displayed on all posts and blog.', 'sktgravida'),
	...
	register_sidebar(array(
	'name'          => __('Page Sidebar', 'sktgravida'),
	'id'            => 'sidebar-page',
	'description'   => __('When you assign widgets to this area, it will be displayed on all pages.', 'sktgravida'),
	'before_widget' => '<div id="%1$s" class="widget %2$s" data-widget-id="%1$s"><div class="widget_wrap">'.$editbutton,
	'after_widget'  => '<span class="widget_corner"></span></div></div>',
	'before_title'  => '<h3 class="widgettitle">',
	'after_title'   => '</h3>'
	...
	register_sidebar( array(
		'name'          => __( 'Header Topbar Left Widget', 'sktgravida' ),
		'description'   => __( 'Appears on header', 'sktgravida' ),
		'id'            => 'headerleft',
	...
	register_sidebar( array(
		'name'          => __( 'Header Topbar Right Widget', 'sktgravida' ),
		'description'   => __( 'Appears on header', 'sktgravida' ),
		'id'            => 'headerright',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 1 Column', 'sktgravida' ),
		'description'   => __( 'Appears on footer 1 columns', 'sktgravida' ),
		'id'            => 'footer-1',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 2 Columns', 'sktgravida' ),
		'description'   => __( 'Appears on footer 2 columns', 'sktgravida' ),
		'id'            => 'footer-2',
		'before_widget' => '<div id="%1$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 3 Columns', 'sktgravida' ),
		'description'   => __( 'Appears on footer 3 columns', 'sktgravida' ),
		'id'            => 'footer-3',
		'before_widget' => '<div id="%1$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 4 Columns', 'sktgravida' ),
		'description'   => __( 'Appears on footer 4 columns', 'sktgravida' ),
		'id'            => 'footer-4',
		'before_widget' => '<div id="%1$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
...
function complete_excerpt_more($more) {
	return '<br><a class="moretag" href="'. get_permalink() . '">'.__('+ Read More', 'sktgravida').'</a>';
}
...
function complete_more_link( $more_link, $more_link_text ) {
	return str_replace( $more_link_text, __('+ Read More', 'sktgravida'), $more_link );
}
...
function complete_search_form( $form ) {
    ...
    <div>
    <input placeholder="' . __( 'Search &hellip;', 'sktgravida' ) . '" type="text" value="' . get_search_query() . '" name="s" id="s" />
    <input type="submit" id="searchsubmit" value="'. __( 'Search', 'sktgravida' ) .'" />
    </div>
    </form>';
...
function complete_comment($comment, $args, $depth) {
   ...
   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
     ...
     <div class="comm_edit"><?php edit_comment_link(__('Edit', 'sktgravida'),'','') ?></div>
      
      
      <div class="comment-author vcard">
            <div class="avatar"><?php echo get_avatar($comment,$size='30' ); ?></div>
            <div class="comm_auth"><?php printf(__('%s', 'sktgravida'), get_comment_author_link()) ?></div>
      ...
      <?php if ($comment->comment_approved == '0') : ?>
         <em><?php _e('Your comment is awaiting moderation.', 'sktgravida') ?></em>
         <br />
      <?php endif; ?>
...
$GLOBALS['comment'] = $comment; ?>
   ...
   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
     ...
     <div id="comment-<?php comment_ID(); ?>" class="comment-body">
           <?php edit_comment_link(__('Edit', 'sktgravida'),'  ','') ?>
      <?php if ($comment->comment_approved == '0') : ?>
         <em><?php _e('Your comment is awaiting moderation.', 'sktgravida') ?></em>
         <br />
      <?php endif; ?>
      ...
      <div class="org_ping">
      	<?php printf(__('<cite class="citeping">%s</cite> <span class="says">:</span>', 'sktgravida'), get_comment_author_link()) ?>
	  	<?php comment_text() ?>
...
function complete_comment_form_fields($fields){
	...
	$fields['author'] = '<div class="comm_wrap"><p class="comment-form-author"><input placeholder="' . __( 'Name', 'sktgravida' ) . '" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) .'" size="30"' . $aria_req . ' /></p>';

	$fields['email'] = '<p class="comment-form-email"><input placeholder="' . __( 'Email', 'sktgravida' ) . '" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) .'" size="30"' . $aria_req . ' /></p>';

	$fields['url'] = '<p class="comment-form-url"><input placeholder="' . __( 'Website', 'sktgravida' ) . '" id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) .'" size="30" /></p></div>';
    return $fields;
}
