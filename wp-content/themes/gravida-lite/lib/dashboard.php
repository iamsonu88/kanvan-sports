  ...
  <div class="notice-content">
    ...
    <h2>
      <?php
							...
							printf( esc_html__( 'Thank you for installing %s.', 'skt-complete' ), '<strong>Gravida Lite</strong>' );
							?>
    </h2>
    <p> <a href="<?php echo esc_url( admin_url( 'themes.php?page=theme-options' ) ); ?>" class="button button-primary">
      <?php
								/* translators: %s: Theme name */
								printf( esc_html__( 'Get started with %s', 'skt-complete' ), 'Gravida Lite' );
								?>
      </a> </p>
    <?php else : ?>
						...
						<div class="skt-complete-customizebox">
                            ...
                            <div class="cust-linkbox">
                            	<ul>
                                    ...
                                    <li><i class="dashicons dashicons-minus"></i><a href="<?php echo esc_url( admin_url( 'customize.php?autofocus[section]=headlayout_section' ) ); ?>"><?php echo esc_html_e('Header Layout','complete');?></a></li>
